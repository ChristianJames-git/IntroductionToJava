...
public class Race extends JFrame {
	...
	private void prepareToRace() {
		...
		while (input != 's' && input != 'S') {
			...
			switch (input) {
				...
				case 'b':
				case 'B':
					racerList.add(new Blob("Blob", START_LINE, yPos));
					yPos += RACER_SPACE;
					break;
				default:
					JOptionPane.showMessageDialog( this, "Try a different letter" );
			}
	 ...
	 */
	private void reportRaceResults() throws InterruptedException {
		raceIsOn = false;
